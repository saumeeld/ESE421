...
class Node:
    ...
    class Edge:
        ...
        def set_equation_of_line(self, node_start, node_end):
            standard_coord = LatLon(39.947604, -75.190101) #A point in the lower left corner of Penn Park that is treated as (0,0)
...
if __name__ == '__main__':
    ...
    my_latlon = LatLon(39.950096, -75.185831) # Set the lat lon of a point you want to test here
    closest_node = get_closest(Nodes.itervalues(), my_latlon)
    print(closest_node.name)

    closest_road = get_closest_road(closest_node, 39.950096, -75.185831) #Set the lat lon of a point you want to test here
